#
#  Be sure to run `pod spec lint ESFileManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.3"
  s.summary      = "file manager for iOS"
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESFileManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESFileManager/ESFileManager/*.{h,m}"
