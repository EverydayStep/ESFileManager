...
{
    return [[ESFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ESFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ESFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ESFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ESFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ESFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
